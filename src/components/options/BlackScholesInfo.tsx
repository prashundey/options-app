                ...
                <Accordion className="bs-accordion" defaultActiveKey="0" flush>
                    ...
                    <Accordion.Item eventKey="2">
                        ...
                        <Accordion.Body>
                                ...
                                <br/>
                                Web-app depends on <a href="https://www.stockoptionsdomain.link/">stockoptionsdomain.link</a> which routes to the backend Spring Boot Application deployed on AWS Elastic Bean. 
                                The bean queries, processes and models real-time data from Yahoo Finance API. 
